...
function Contact() {
  return (
    ...
    <section class="relative overflow-hidden px-24" id="contact">
      <div class="container px-24 mx-auto min-h-screen">
          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0 text-white">
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                <div class="bg-blue-500 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-body-color text-base hover:text-blue-400"><a href="tel:+249969676735">(+249) 96 967 6735</a></p>
                </div>
              </div>
              <div class="mb-8 flex w-full max-w-[370px]">
                <div class="bg-blue-500 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-body-color text-base hover:text-blue-400"><a href="mailto:almujtaba.abdu@gmail.com">almujtaba.abdu@gmail.com</a></p>
                </div>
              </div>
            </div>
          </div>
          <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div class="relative bg-blue-400 rounded-lg border bg-opacity-20 backdrop-blur-xl drop-shadow-lg border-blue-900 p-8 shadow-lg sm:p-12">
              <form>
                <div class="mb-6">
                  <input
                    type="text"
                    placeholder="Your Name"
                    class="text-body-color focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  />
                </div>
                <div class="mb-6">
                  <input
                ...
                <div class="mb-6">
                  <textarea
                    ...
                    class="text-body-color focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  ></textarea>
                </div>
                <div>
                  <button
                    type="submit"
                    class="bg-blue-500 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
